...
# 👋 Olá, eu sou o João Werner

### 💻 Estudante de ADS | Desenvolvimento | Suporte Técnico | 🚀 Em busca de estágio em TI
...
Sou estudante de **Análise e Desenvolvimento de Sistemas (PUC Minas)**, apaixonado por tecnologia e focado em construir soluções através da programação.

Atualmente desenvolvo projetos práticos para evoluir em **desenvolvimento de software, lógica e aplicações web**, sempre buscando crescimento profissional e aprendizado contínuo.
...
### 🌐 Elo Saúde
Plataforma web com foco em informação e acolhimento.

✔ Interface moderna  
✔ Conteúdo estruturado  
✔ Navegação intuitiva  
✔ Projeto real em evolução  

---

### 🛒 E-commerce G2
Sistema em C# com Programação Orientada a Objetos.
...
### 💻 Projetos Web
Projetos voltados à prática de front-end.
